...
#Functions go here
def string_check(question, valid_answers=('yes', 'по'),
                num_letters=1):
    """Checks that users enter the full word
    or the 'n' letter/s of a word from a list of valid response"""
...
Once you have either sold all of the tickets or entered the exit code ('xxx'), the program will display the ticket sales information and write the data to a text file.
...
while tickets_sold < MAX_TICKETS:
    ...
    # Output error message / success messag
    if age < 12:
...
raffle_heading = make_statement("--- Raffle Winner decoration:", "-")
adjusted_sales_heading = make_statement("Adjusted Sales & Profit","-")

adjusted_explanation = (f"We have given away a ticket worth ${ticket_won:.2f} which means our"
                        f"sales have decreased by ${ticket_won:.2f} and our profit \n" 
                        f"decreased by ${profit_won:.2f}")

#List of strings to be outputted / wri
